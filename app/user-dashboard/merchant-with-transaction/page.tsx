"use client"
import MyMerchantAtmReportTable from "@/components/table/my-merchant-atm-table";
    ...
    <div className="max-w-screen">
      ...
      <div className="flex flex-col w-full items-center">
        <div className="flex flex-col w-full max-w-9xl px-4 pt-6">
          <p className="text-3xl font-bold">My Merchant ATM Reporting</p>
        ...
        <div className="w-full px-4">
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-full lg:col-span-10 xl:col-span-12 overflow-auto">
              <MyMerchantAtmReportTable setViewVoucher={setViewVoucher} />
            </div>
          </div>
        </div>
      </div>
